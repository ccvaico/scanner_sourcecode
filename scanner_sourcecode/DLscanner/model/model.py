...
def get_embedding_matrix(tokenizer):
    ...
    EMBEDDING_FILE = '../embeddings/embeddings/wiki-news-300d-1M/wiki-news-300d-1M.vec'
    def get_coefs(word,*arr):
        return word, np.asarray(arr, dtype='float32')
    ...
    EMBEDDING_FILE = '../embeddings/embeddings/paragram_300_sl999/paragram_300_sl999.txt'
    def get_coefs(word, *arr):
        return word, np.asarray(arr, dtype='float32')
